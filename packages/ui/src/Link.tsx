...
let openExternalUrlImpl: (url: string) => void = (url) => {
  if (typeof window !== "undefined") {
    window.open(url, "_blank", "noopener,noreferrer");
  }
};

/** Optional host hook (Electron) so ExternalLink can reuse desktop openers. */
export function setExternalUrlOpener(opener: (url: string) => void): void {
  openExternalUrlImpl = opener;
}
