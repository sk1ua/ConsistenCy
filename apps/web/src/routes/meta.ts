...
const en = {
  inbox: { title: "Review", shortTitle: "Review", description: "Evidence-backed signals across active pull requests", section: "Review" },
  ...
  reports: { title: "Review report", shortTitle: "Report", description: "Inspect findings, evidence, and agent decisions", section: "Reviews" },
...
const zh: typeof en = {
  inbox: { title: "审查", shortTitle: "审查", description: "查看活跃拉取请求中有证据支撑的信号", section: "审查" },
  repositories: { title: "仓库", shortTitle: "仓库", description: "查看审查来源与实时本地仓库监控", section: "审查" },
  runs: { title: "审计运行", shortTitle: "运行", description: "跟踪从接收到决策的每次审查", section: "审查" },
  reports: { title: "审查报告", shortTitle: "报告", description: "检查发现、证据与智能体结论", section: "审查" },
